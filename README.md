...
``` bash
curl -s https://raw.githubusercontent.com/BS-Eg/141/main/run.sh | sudo bash -s 141 10141 20141
```

to set up first Odoo instance @ `localhost:10141` (default master password: `BS@147258`)
...
* Then open `localhost:10141` to access Odoo 16.0. If you want to start the server with a different port, change **10141** to another value in **docker-compose.yml**:
...
server {
    ...
    location /longpolling/ {
        proxy_pass http://0.0.0.0:20141/longpolling/;
    }
    #...
}
#...
...
<img src="screenshots/odoo-14-apps-screenshot.png" width="50%">

<img src="screenshots/odoo-14-welcome-screenshot.png" width="100%">
